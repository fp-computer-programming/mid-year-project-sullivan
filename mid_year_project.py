...
def chutes_and_ladders():
    ...
    if ladders2 == chutes1 & chutes1 != 6:
        ladders1 += 1
    else: ladders2 -= 1
    if ladders2 == chutes2 & chutes2 != 6:
        ladders2 += 1
    else: ladders2 -= 1
    if ladders2 == chutes3 & chutes3 != 6:
        ladders2 += 1
    else: ladders2 -= 1
    if ladders3 == chutes1 & chutes1 != 6:
        ladders3 += 1
    else: ladders3 -= 1
    if ladders3 == chutes2 & chutes2 != 6:
        ladders3 += 1
    else: ladders3 -= 1
    if ladders3 == chutes3 & chutes3 != 6:
        ladders3 += 1
    else: ladders3 -= 1
